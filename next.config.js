...
const nextConfig = {
  ...
  async redirects() {
    const nestedRedirects = [
      ...
      { source: '/admin/listings', destination: '/administracja/zgloszenia' },
      { source: '/administracja/ogloszenia', destination: '/administracja/zgloszenia', permanent: true },
      { source: '/administracja/ogloszenia/:path*', destination: '/administracja/zgloszenia/:path*', permanent: true },
