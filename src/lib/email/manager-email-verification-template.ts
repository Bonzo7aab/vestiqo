/**
 * Manager registration email confirmation — styled like `password-reset-template.ts`.
 * Sent via Resend (not Supabase Auth confirmation mailer / OPD-171).
 */
export const MANAGER_EMAIL_VERIFICATION_SUBJECT = 'Potwierdź adres email w Vestiqo';
...
export function buildManagerEmailVerificationHtml(params: {
  confirmUrl: string;
}): string {
...
<head>
  ...
  <title>Potwierdź adres email — Vestiqo</title>
</head>
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:520px;background-color:#FFFFFF;border-radius:16px;border:1px solid #E2E8F0;overflow:hidden;box-shadow:0 4px 24px rgba(15,23,42,0.06);">
          <tr>
            <td style="background:linear-gradient(135deg,#1D4ED8 0%,#2563EB 100%);padding:36px 32px;text-align:center;">
              ...
              <h1 style="margin:0;color:#FFFFFF;font-size:26px;font-weight:700;line-height:1.2;letter-spacing:-0.02em;">Potwierdź adres email</h1>
          ...
          <tr>
            <td style="padding:36px 32px 32px;">
              ...
              <p style="margin:0 0 28px;color:#334155;font-size:15px;line-height:1.65;">
                Konto w <strong style="color:#0F172A;">Vestiqo</strong> zostało utworzone. Potwierdź adres email, a następnie poczekaj na weryfikację przez administratora.
              </p>
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 auto 28px;">
                <tr>
                  <td align="center" style="border-radius:10px;background-color:#2563EB;">
                    <a href="${confirmUrl}" target="_blank" style="display:inline-block;padding:14px 32px;color:#FFFFFF;font-size:16px;font-weight:600;text-decoration:none;border-radius:10px;line-height:1.2;">
              ...
              <p style="margin:0;color:#64748B;font-size:13px;line-height:1.55;">
                Link jest ważny przez 72 godziny. Jeśli to nie Ty zakładałeś konto, zignoruj tę wiadomość.
              </p>
            </td>
          </tr>
          <tr>
